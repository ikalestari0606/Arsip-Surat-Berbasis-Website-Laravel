...
<head>
    ...
    <title>E-Laporan Kegiatan - Register</title>
    ...
    <div class="container">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block bg-image-new"></div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form action="{{ route('register.simpan') }}" method="POST" class="user">
                                ...
                                <div class="form-group">
                                    <input name="nip" type="text"
                                        ...
                                        id="exampleInputNip" placeholder="NIP">
                                    @error('nip')
                                ...
                                <div class="form-group">
                                    <input name="nama" type="nama"
                                        ...
                                        id="exampleInputNama" placeholder="Nama">
                                    @error('nama')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
